...
class PlayerWidget extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _PlayerWidgetState(url, isLocal, mode, urls, totalDuration);
  }

  @override
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    // properties.add(IntProperty('totalDuration', _du));
  }
}
...
class _PlayerWidgetState extends State<PlayerWidget> {
  ...
  _PlayerWidgetState(
      this.url, this.isLocal, this.mode, this.urls, this.totalDuration);
        ...
        Row(
          ...
          children: [
            ...
            IconButton(
              ...
              onPressed: () {
//              _audioPlayer.seek(Duration(seconds: await _audioPlayer.getCurrentPosition() + 10));
                _audioPlayer.seek(Duration(seconds: _position.inSeconds + 10));
              },
              iconSize: 40.0,
            ),
